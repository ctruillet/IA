...
public class EtatCas3 implements Etat {
    ...
    */
    ...
    public EtatCas3(GrapheDeLieux tg, int lieuDepart, int etat, ArrayList<Integer> listeSommetsVisite) {
        this.tg = tg;
        this.lieuDepart = lieuDepart;
        this.etat = etat;
    ...
    */
    public List<Etat> successeurs() {
        ...
        for(Lieu adj : this.tg.getLesLieux()){
            //if(adj.getNom() != this.etat){
                if(adj.getNom()==lieuDepart){
                    if(this.listeSommetsVisite.size() == this.tg.getNbSommets()){
                        liste.add(new EtatCas3(this.tg, this.lieuDepart, adj.getNom(), this.listeSommetsVisite));
                    }
                }else{
                    if(!this.listeSommetsVisite.contains(adj.getNom()))
                        liste.add(new EtatCas3(this.tg, this.lieuDepart, adj.getNom(), this.listeSommetsVisite));
                }
            //}
        }
    ...
    */
    public double k(Etat e) {
        return this.tg.dist(this.etat, ((EtatCas3)e).getEtat());
    }
    ...
    */
    public void displayPath(Map<Etat, Etat> pere) {
        Etat e = this;
        String s = "";
        int lieu = (int) ((EtatCas3)e).getEtat();
        s += lieu;
        while(pere.containsKey(e)) {
            e = pere.get(e);
            if(e == null) break;
            lieu = (int) ((EtatCas3)e).getEtat();
            s = ((EtatCas3)e).getEtat() + "-" + s;            
        }
    ...
    */
    public int compareTo(Object o) {
        ...
        return (this.tg.dist(this.etat, this.lieuDepart) <= this.tg.dist(((EtatCas3)o).getEtat(),((EtatCas3)o).lieuDepart)?-1:1);
    ...
    */
    public boolean equals(Object o) {
        if (! (o instanceof EtatCas3)){
            return false;
        }

        return this.hashCode() == ((EtatCas3)o).hashCode();
    }
